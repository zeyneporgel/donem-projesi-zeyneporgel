...
namespace YurtKayıtSistemiii
{
    public partial class FrmOgrListe : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurtkayıtDataSet17.Ogrenci' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.ogrenciTableAdapter.Fill(this.yurtkayıtDataSet17.Ogrenci);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            fr.telefon = dataGridView1.Rows[secilen].Cells[5].Value.ToString();

...
namespace YurtKayıtSistemiii
{
    public partial class FrmGiderListesi : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurtkayıtDataSet16.Giderler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.giderlerTableAdapter.Fill(this.yurtkayıtDataSet16.Giderler);
